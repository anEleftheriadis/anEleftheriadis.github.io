...
if (!class_exists('GreenshiftMenuSettings')) {
    ...
    background: #edf3fb;}
				...
				<div class="gs-padd">
					<div class="gs_grid">
						<div class="greenshift_form gs_grid_1">
							<h1><?php esc_html_e("Getting Started with Greenshift", 'greenshift'); ?></h1>

							<p class="gs-introtext"><?php esc_html_e("Thank you for using Greenshift, FSE block theme.", 'greenshift'); ?></p>
							<p class="gs-introtext gs-intro-notice"><?php esc_html_e("If you are looking for Theme options, you can find them in", 'greenshift'); ?> <a href="<?php echo get_admin_url(null, 'site-editor.php');?>"><?php esc_html_e("Site editor", 'greenshift'); ?></a>. <?php esc_html_e("Click on Gears icon in top toolbar to open theme options", 'greenshift'); ?>. <?php esc_html_e("More global options can be added in recommended", 'greenshift'); ?> <a href="https://wordpress.org/plugins/greenshift-animation-and-page-builder-blocks/" target="_blank"><?php esc_html_e("Greenshift plugin", 'greenshift'); ?></a></p>
							<div class="gs-intro-video">
								<a href="https://www.youtube.com/watch?v=CkkayWgq2uY" target="_blank">
									<img style="max-width:100%" src="<?php echo esc_url(get_template_directory_uri()); ?>/inc/admin_menu/assets/fsetutorial.jpg" alt="Greenshift video" />
								</a>
							</div>
						</div>
						<div class="gs_grid_2">
							<div class="greenshift_form">
								<h3><?php esc_html_e("Recommended tutorials", 'greenshift'); ?></h3>
								<div class="gs_main_text"><a href="https://www.youtube.com/watch?v=GxKUPFOI1fI" target="_blank"><?php esc_html_e("In depth overview for FSE workflow", 'greenshift'); ?></a></div>
								<div class="gs_main_text"><a href="https://youtu.be/Pvaqjz16QHk" target="_blank"><?php esc_html_e("Layout Options - start here", 'greenshift'); ?></a></div>
								<div class="gs_main_text"><a href="https://www.youtube.com/watch?v=ijo7sBKGPIQ" target="_blank"><?php esc_html_e("In depth overview of unique options", 'greenshift'); ?></a></div>
								<div class="gs_main_text"><a href="https://www.youtube.com/watch?v=Bq5iXVYCIFk" target="_blank"><?php esc_html_e("How to make Mega menu", 'greenshift'); ?></a></div>
								<div class="gs_main_text"><a href="https://youtube.com/playlist?list=PLIEKo1RENmYxbs3yL3nMuOzJJ0AY6GvQ2" target="_blank"><?php esc_html_e("Animation Addon overview", 'greenshift'); ?></a></div>
								<div class="gs_main_text"><a href="https://www.youtube.com/playlist?list=PLIEKo1RENmYynw2olUEr8-wq7RDA3CQFQ" target="_blank"><?php esc_html_e("Make Dynamic sites on Greenshift query addon", 'greenshift'); ?></a></div>
							</div>
							<div class="greenshift_form">
								<h3><?php esc_html_e("Get support", 'greenshift'); ?></h3>
								<p class="gs_intro_text"><?php esc_html_e("Do you need help. Check our official support channels and feel free to use them.", 'greenshift'); ?></p>
								<div class="gs_main_text"><a href="https://shop.greenshiftwp.com/contact-us/" target="_blank">
										<?php esc_html_e("Contact Us", 'greenshift'); ?>
									</a></div>
							</div>
							<div class="greenshift_form">
								<h3><?php esc_html_e("Our community", 'greenshift'); ?></h3>
								<p class="gs_intro_text"><?php esc_html_e("Do you want to share some ideas, recommendations or simply want to introduce your site on our plugin or theme. Check our community channels", 'greenshift'); ?></p>
								<div style="display:flex; gap:10px">
									<a href="https://twitter.com/GreenshiftWP" target="_blank">
										<svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 122.88 37.203" enable-background="new 0 0 122.88 37.203" xml:space="preserve" style="width: 120px;">
											<g>
									...
									<a href="https://www.facebook.com/groups/greenshiftwp" target="_blank">
										<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 122.88 34.35" width="120px">
											<defs>
												<style>
													.cls-1 {
														fill: #1877f2;
